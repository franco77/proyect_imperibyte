<div class="blog">
            <div class="container">
                    <div class="row">
                 <div class="col-lg-6 col-lg-offset-3 text-center blog_title">  
           ...
           <div class="row">
			    ...
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 blog_row" data-aos="fade-right">
					...
					<div class="col-lg-6 col-xs-12">
						 <div class="blog-column">
							...
							<a class="secondary-button secondary-button-inverse" href="#">Read More</a>
						</div>
					</div>
